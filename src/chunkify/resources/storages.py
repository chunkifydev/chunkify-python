...
class StoragesResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        provider: Literal["chunkify", "aws", "cloudflare"],
        ...
        return self._post(
            "/api/storages",
            body=maybe_transform({"provider": provider}, storage_create_params.StorageCreateParams),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/api/storages",
            body=await async_maybe_transform({"provider": provider}, storage_create_params.StorageCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=StorageCreateResponse,
