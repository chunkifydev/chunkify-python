...
class TestJobs:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_files(self, client: Chunkify) -> None:
        job = client.jobs.get_files(
            "jobId",
        )
        assert_matches_type(JobGetFilesResponse, job, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_files(self, client: Chunkify) -> None:
        response = client.jobs.with_raw_response.get_files(
            "jobId",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_get_files(self, client: Chunkify) -> None:
        with client.jobs.with_streaming_response.get_files(
            "jobId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_get_files(self, client: Chunkify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.jobs.with_raw_response.get_files(
                "",
            )

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_logs(self, client: Chunkify) -> None:
        job = client.jobs.get_logs(
            job_id="jobId",
            service="transcoder",
        )
        assert_matches_type(JobGetLogsResponse, job, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_logs_with_all_params(self, client: Chunkify) -> None:
        job = client.jobs.get_logs(
            job_id="jobId",
            service="transcoder",
            transcoder_id=0,
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_logs(self, client: Chunkify) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_get_logs(self, client: Chunkify) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_get_logs(self, client: Chunkify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_transcoders(self, client: Chunkify) -> None:
        job = client.jobs.get_transcoders(
            "jobId",
        )
        assert_matches_type(JobGetTranscodersResponse, job, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_transcoders(self, client: Chunkify) -> None:
        response = client.jobs.with_raw_response.get_transcoders(
            "jobId",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_get_transcoders(self, client: Chunkify) -> None:
        with client.jobs.with_streaming_response.get_transcoders(
            "jobId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_get_transcoders(self, client: Chunkify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.jobs.with_raw_response.get_transcoders(
                "",
            )
...
class TestAsyncJobs:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_files(self, async_client: AsyncChunkify) -> None:
        job = await async_client.jobs.get_files(
            "jobId",
        )
        assert_matches_type(JobGetFilesResponse, job, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_get_files(self, async_client: AsyncChunkify) -> None:
        response = await async_client.jobs.with_raw_response.get_files(
            "jobId",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_get_files(self, async_client: AsyncChunkify) -> None:
        async with async_client.jobs.with_streaming_response.get_files(
            "jobId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_get_files(self, async_client: AsyncChunkify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.jobs.with_raw_response.get_files(
                "",
            )

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_logs(self, async_client: AsyncChunkify) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_logs_with_all_params(self, async_client: AsyncChunkify) -> None:
        job = await async_client.jobs.get_logs(
            job_id="jobId",
            service="transcoder",
            transcoder_id=0,
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_get_logs(self, async_client: AsyncChunkify) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_get_logs(self, async_client: AsyncChunkify) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_get_logs(self, async_client: AsyncChunkify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_transcoders(self, async_client: AsyncChunkify) -> None:
        job = await async_client.jobs.get_transcoders(
            "jobId",
        )
        assert_matches_type(JobGetTranscodersResponse, job, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_get_transcoders(self, async_client: AsyncChunkify) -> None:
        response = await async_client.jobs.with_raw_response.get_transcoders(
            "jobId",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_get_transcoders(self, async_client: AsyncChunkify) -> None:
        async with async_client.jobs.with_streaming_response.get_transcoders(
            "jobId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_get_transcoders(self, async_client: AsyncChunkify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.jobs.with_raw_response.get_transcoders(
                "",
            )
